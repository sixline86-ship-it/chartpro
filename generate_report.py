...
- 돈의흐름: 오늘 자금이 어디서 빠져 어디로 갔는지 정리한다.
  · 요약: 자금 흐름을 한 문장으로. (예: "반도체에서 빠진 돈이 제습기·손보로 갔습니다")
  · 유입: 돈이 들어온 곳 2~3개. 각각 {"이름": "...", "설명": "짧게"}
  · 유출: 돈이 빠진 곳 2~3개. 같은 형식.
  · 해석: 이 이동이 무엇을 뜻하는지 2~3문장. 순환매인지, 이탈인지, 대기자금인지.
  · 반드시 입력 데이터(수급·주도섹터·거래대금)에 있는 숫자만 근거로 쓴다.
