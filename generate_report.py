...
- 돈의흐름: ⚠️ 위쪽 '지수+수급'에 이미 나온 숫자를 되풀이하지 마라.
  ...
  · 프로그램해석: 프로그램매매의 차익거래와 비차익거래를 구분해 설명한다.
    ...
    같은 '프로그램 순매도'라도 어느 쪽이 컸는지에 따라 해석이 정반대임을 짚어준다.
